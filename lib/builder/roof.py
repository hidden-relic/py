...
class builder:
	...
	def convert(self, i):
		i_int = int(i)
		return math.floor(i_int/12), round(i_int % 12), fractions.Fraction(i-i_int).limit_denominator(16)
	...
	def rafter(self):
		...
		def ruler(o):
			...
			info_ft, info_in, info_frac = o.convert(o.width/2)
			...
			rt.width(1)
			rt.fd((o.rise*2-50)/2)
			info_ft, info_in, info_frac = o.convert(o.rise/o.scale_to)
			rt.write(str(info_ft) + "' " + str(info_in) + str(info_frac) + '"')
			rt.fd((o.rise*2-50)/2)
			rt.stamp()
			bottom = rt.pos()
			...
			info_ft, info_in, info_frac = o.convert(o.leg/o.scale_to)
			rt.write(str(info_ft) + "' " + str(info_in) + str(info_frac) + '"')
			leg_center = rt.pos()
			rt.goto(top[0], top[1])
			rt.pu()
			rt.goto(o.heel_corner[0]+o.toPixel(12), o.heel_corner[1])
			heel_cut_ft, heel_cut_in, heel_cut_frac = o.convert(o.heel_cut)
