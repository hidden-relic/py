...
###########################3##############
	...
	def buildDeckInput(self):
 		...
 		self.deck_material_width_frame=tk.Frame(self.deck_input_tab)
 		...
 		def buildWidth(self):
 			...
 			def buildWFt(self):
 				...
 				tk.Label(self.deck_width_ft_frame, text = "ft.", font = self.myfont).pack(padx = 6, ipadx = 12)
 				self.deck_width_ft = ttk.Combobox(self.deck_width_ft_frame, height = 20, width = 6, values = tuple(self.vals['ft']), font = self.myfont, state = 'readonly')
